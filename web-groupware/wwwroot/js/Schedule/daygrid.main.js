...
!(function (e, t) {
            ...
            return (
                ...
                (r.prototype.renderNumberCellHtml = function (e) {
                    ...
                    return d || this.renderProps.cellWeekNumbersVisible
                        ? ((r = t.getDayClasses(e, this.props.dateProfile, this.context)).unshift("fc-day-top"),
                          ...
                          this.renderProps.cellWeekNumbersVisible && e.getUTCDay() === n && (l += t.buildGotoAnchorHtml(s, o, { date: e, type: "week" }, { class: "fc-week-number" }, o.format(e, v))),
                ...
                (r.prototype.positionToHit = function (e, t) {
                    var r = this.colPositions,
                        ...
                        o = n.topToIndex(t);
                    if (null != o && null != i)
                        return { row: o, col: i, dateSpan: { range: this.getCellRange(o, i), allDay: !0 }, dayEl: this.getCellEl(o, i), relativeRect: { left: r.lefts[i], right: r.rights[i], top: n.tops[o], bottom: n.bottoms[o] } };
                }),
                ...
                (r.prototype._renderEventResize = function (e) {
                    e &&
                        (this.eventRenderer.hideByHash(e.affectedInstances), this.fillRenderer.renderSegs("highlight", this.context, e.segs), this.mirrorRenderer.renderSegs(this.context, e.segs, { isResizing: !0, sourceSeg: e.sourceSeg }));
                }),
                (r.prototype._unrenderEventResize = function (e) {
                    e && (this.eventRenderer.showByHash(e.affectedInstances), this.fillRenderer.unrender("highlight", this.context), this.mirrorRenderer.unrender(this.context, e.segs, { isResizing: !0, sourceSeg: e.sourceSeg }));
                }),
                ...
                (r.prototype.renderMoreLink = function (e, r, n) {
                    ...
                    return (
                        ...
                        h.addEventListener("click", function (t) {
                            ...
                            "function" == typeof o && (o = s.publiclyTrigger("eventLimitClick", [{ date: a.toDate(p), allDay: !0, dayEl: f, moreEl: u, segs: g, hiddenSegs: y, jsEvent: t, view: l }])),
                    ...
                    s.rowEls
                        ? (this.colWeekNumbersVisible && (this.weekNumberWidth = t.matchCellWidths(t.findElements(this.el, ".fc-week-number"))),
                          ...
                          n ||
                              ...
                              ((o = this.scroller.getScrollbarWidths()).left || o.right) && (a && t.compensateScroll(a, o), (i = this.computeScrollerHeight(r)), this.scroller.setHeight(i)),
        ...
        R = (function (e) {
            ...
            return (
                ...
                (r.prototype.render = function (t, r) {
                    ...
                    this.header && this.header.receiveProps({ dateProfile: n, dates: i.headerDates, datesRepDistinctDays: 1 === i.rowCnt, renderIntroHtml: this.renderHeadIntroHtml }, r),
    ...
    var k = t.createPlugin({
        ...
        views: { dayGrid: R, dayGridDay: { type: "dayGrid", duration: { days: 1 } }, dayGridWeek: { type: "dayGrid", duration: { weeks: 1 } }, dayGridMonth: { type: "dayGrid", duration: { months: 1 }, monthMode: !0, fixedWeekCount: !0 } },
    });
