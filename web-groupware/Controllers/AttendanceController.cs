...
namespace web_groupware.Controllers
{
    public class AttendanceController : BaseController
    {
        ...
        /*public AttendanceController(web_groupwareContext context)
        {
            _context = context;
        }*/
        ...
        public async Task<IActionResult> Index(DateTime? date)
        {
            ...
            {
                StaffMembers = await _context.T_STAFFM.ToListAsync(),
        ...
        public async Task<IActionResult> Index(int? year, int? month, int? days, int[] state, string? staff_name, int? staff_num)
        {
            ...
            var existingRecord = _context.T_AttendanceDate.FirstOrDefault(a => a.staf_cd == staff_num && a.request_date == requestDate);
            ...
            else
            {
                ...
                var saveData = new T_AttendanceDate
                {
                ...
                _context.T_AttendanceDate.Add(saveData);
                await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult> ExportToExcel(int staf_cd, int year)
        {
            ...
            /*string filePath = Path.Combine(webRootPath, "Files", "Attendance.xlsx");*/
            ...
            var data = await _context.T_AttendanceDate             
