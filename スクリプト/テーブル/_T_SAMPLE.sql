...
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[T_SAMPLE]') AND type in (N'U'))
DROP TABLE [dbo].[T_SAMPLE]
GO
...
CREATE TABLE [dbo].[T_SAMPLE](
 ...
 CONSTRAINT [PK_T_SAMPLE_1] PRIMARY KEY CLUSTERED 
(
	[bukken_cd] ASC
